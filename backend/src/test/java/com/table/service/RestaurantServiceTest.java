...
//
//    private RestaurantRepo tempRepositoryMock;
//    private RestaurantService restaurantService;
//
//    @BeforeEach
//    void beforeEach() {
//        tempRepositoryMock = mock(TempRepository.class);
//        restaurantService = new RestaurantService(tempRepositoryMock, tableRepo);
//    }
//
//    @Disabled
//    @Test
...
//        Restaurant restaurant1 = new Restaurant(new RestaurantDTO("restaurant1", "fakeEmail", "admin", "555-555", "street street 15201"), id1);
//        Restaurant restaurant2 = new Restaurant(new RestaurantDTO("restaurant2", "fakeEmail", "admin", "555-555", "street street 15201"), id2);
...
//
//        RestaurantDTO newRestaurantDTO = new RestaurantDTO("restaurant1", "fakeEmail", "admin", "555-555", "street street 15201");
//
...
//        Restaurant restaurant1 = new Restaurant(new RestaurantDTO("restaurant1", "fakeEmail", "admin", "555-555", "street street 15201"), uuid);
