...
INSERT INTO dining_spot (id, public_id, capacity, name, restaurant_id) VALUES (nextval('dining_seq'), 'b06b4f1d-6d6e-4576-9a97-5507c4b2a243', 6, 'Table 2', 1);
INSERT INTO dining_spot (id, public_id, capacity, name, restaurant_id) VALUES (nextval('dining_seq'), 'efc16827-df20-4fd1-86a7-9bb0a66deba5', 5, 'Table 3', 2);
INSERT INTO dining_spot (id, public_id, capacity, name, restaurant_id) VALUES (nextval('dining_seq'), 'efc16827-df20-4fd1-86a7-9bb0a66deba7', 8, 'Table 4', 2);
...
INSERT INTO reservation (id, public_id, start, duration, number_of_customers, customer_id, dining_spot_id) VALUES (nextval('reservation_seq'), '7df4b9a8-38d5-4841-bb9a-2d892b15e43c', '2024-04-01 18:00:00', 1, 4, 1, 2);
...
INSERT INTO reservation (id, public_id, start, duration, number_of_customers, customer_id, dining_spot_id) VALUES (nextval('reservation_seq'), '7df4b9a8-38d5-4841-bb9a-2d892b15e43c', '2024-04-03 12:00:00', 1, 6, 1, 2);
...
INSERT INTO reservation (id, public_id, start, duration, number_of_customers, customer_id, dining_spot_id) VALUES (nextval('reservation_seq'), '7df4b9a8-38d5-4841-bb9a-2d892b15e43c', '2024-03-25 17:00:00', 1, 4, 1, 2);
...
INSERT INTO reservation (id, public_id, start, duration, number_of_customers, customer_id, dining_spot_id) VALUES (nextval('reservation_seq'), '7df4b9a8-38d5-4841-bb9a-2d892b15e43c', '2024-03-27 15:00:00', 1, 6, 1, 2);
