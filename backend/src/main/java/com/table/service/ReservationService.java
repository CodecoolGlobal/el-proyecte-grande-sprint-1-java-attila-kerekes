...
public class ReservationService {
    ...
    @Autowired
    public ReservationService(ReservationRepo reservationRepo, CustomerRepo customerRepo, DiningSpotRepo diningSpotRepo) {
        this.reservationRepo = reservationRepo;
        this.customerRepo = customerRepo;
        this.diningSpotRepo = diningSpotRepo;
    }

    public List<DiningSpot> getSuitableTables(int numberOfGuests, UUID publicId) {
    ...
    private ReservationDTO convertReservationEntityToDTO(Reservation reservation) {
        return new ReservationDTO(
          ...
          reservation.getNumberOfCustomers(),
          reservation.getCustomer().getPublicId(),
          reservation.getDiningSpot().getRestaurant().getPublicId(),
          reservation.getDiningSpot().getPublicId());
    }
